package com.android.shopmaker.common.util
...
object CommonUtil {
    ...
    fun isConnected(): Boolean {
        val connectivityManager =
            com.android.shopmaker.AppApplication.ctx!!.getSystemService(Context.CONNECTIVITY_SERVICE) as ConnectivityManager
